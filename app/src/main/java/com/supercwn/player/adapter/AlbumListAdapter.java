...
import com.supercwn.player.AlbumDetailActivity;
...
public class AlbumListAdapter extends BaseAdapter {
    ...
    private void setupViewHolder(View view, int i, final ViewHolder viewHolder, final SCAlbum album) {
        ...
        if(imageUrl != null) {
            ...
            if(mColumns == 2)
                viewHolder.videoImage.setImageDrawable(SuperApplication.getResource().getDrawable(R.drawable.loading_hor));
            if(mColumns == 3)
                viewHolder.videoImage.setImageDrawable(SuperApplication.getResource().getDrawable(R.drawable.loading));
        }
        ...
        viewHolder.resultContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mChannel.getChannelID() == SCChannel.BIG_MOVIE)
