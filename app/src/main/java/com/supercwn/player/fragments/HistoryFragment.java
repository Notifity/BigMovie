...
import com.supercwn.player.database.History;
 ...
 * Use the {@link com.supercwn.player.fragments.HistoryFragment#newInstance} factory method to
...
public class HistoryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFailReason = SuperApplication.getResource().getString(R.string.fail_reason_no_history);
